...
def main():
    ...
    output_file = 'forward_data.csv'
   # laliga_santander.print_santander(csv_file)    #Prints all of LaLiga Santander statistics unformatted
    laliga_santander_forward.save_santander_forward(csv_file, output_file)  # Prints all LaLiga Santander forward statistics formatted
